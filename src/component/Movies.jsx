...
const Movies = ({dt}) => {
  const router = useRouter();
    ...
    console.log(dt,"dt")
  return (
    <div onClick={()=> router.push(`/movie/${dt?.id}`)} className='min-w-[440px] relative imgContainer cursor-pointer'>
        <Image style={{objectFit:"cover"}} width={440} height={300} src={`https://image.tmdb.org/t/p/original/${dt?.backdrop_path || dt?.poster_path}`}/>
